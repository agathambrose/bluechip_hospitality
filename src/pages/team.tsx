		...
		<div>
			...
			<div className="font-NotoSerif">
				<div className="relative">
					<div className="flex object-fill w-full h-[500px] bg-gray-500 bg-team-hero md:bg-team-hero-md lg:bg-team-hero bg-no-repeat bg-cover justify-start relative"></div>
