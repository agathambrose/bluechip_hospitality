				...
				<div className="lg:hidden">
					...
					<div className="flex justify-center">
						<p className="text-gray-600 text-center md:w-10/12 text-lg">
							...
							euismod penatibus velit, eget. Egestas diam gravida tempus, magnis
							eget turpis orci tortor nascetur. Augue eu eget suspendisse
							consequat quis at. Arcu sagittis fames arcu, odio. Neque vel diam
							aliquam, consequat, sed. Sed proin eu arcu orci ultricies nunc. Ut
							sit purus suspendisse nibh purus placerat vestibulum. Cras donec
							fermentum porttitor quis lectus quam. Turpis pretium mattis purus
							a tortor. Cras.
						</p>
					</div>
				</div>
				...
				<div className="flex flex-col relative justify-center items-center py-8">
					<div className="flex flex-col py-5 justify-center items-center">
						...
						<p className="text-gray-600 text-center mt-4 lg:w-3/5 md:w-10/12 text-lg">
							...
							amet, hendrerit in sollicitudin faucibus aenean volutpat in vel.
							Pretium neque cursus scelerisque aliquet hendrerit adipiscing amet
							enim. Nunc blandit non ultrices imperdiet vitae. Et pulvinar
							lobortis lacus pulvinar adipiscing magnis tincidunt ipsum. Luctus
							turpis pharetra tempus in. Ut tellus id vestibulum aenean pretium
							nunc, elit. At vel, volutpat tempor pulvinar. Tortor facilisis
							viverra sit quam mauris. Diam tincidunt consectetur vestibulum et
							aenean sed et, molestie duis. Est ultricies aliquam tellus nec. Eu
							eget et quam ut dictumst risus enim lorem leo. Ultrices a sagittis
							fames odio. Platea enim in quis tincidunt commodo, id quis.
							Tincidunt interdum urna mauris pharetra, vitae. Tempus faucibus
							eros, arcu vestibulum ut convallis aenean nec commodo. In at
							iaculis nulla diam a viverra et. Enim.
						</p>
					</div>
