	...
	theme: {
		extend: {
			...
			backgroundImage: {
				...
				"home-hero-lg": "url('/assets/images/homepic.svg')",
				"about-hero": "url('/assets/images/about-sm.png')",
				"about-hero-md": "url('/assets/images/about-md.png')",
				"about-hero-lg": "url('/assets/images/about.svg')",
				"services-hero-lg": "url('/assets/images/services.svg')",
				...
				"portfolio-hero-lg": "url('/assets/images/portfolio.svg')",
